...
\begin{warnbox}
Label supply wires as \texttt{vdd!} and \texttt{gnd!}---not
\texttt{VDD}, \texttt{GND}, or any other variant.
...
\begin{tipbox}
Keep your poly strip as narrow as DRC allows.
Wide poly increases gate capacitance and degrades switching speed.
\end{tipbox}
...
again.''
The consequences in industry are severe: several companies explicitly
list bypassing LVS as \textbf{grounds for immediate dismissal}.
...
Be warned: \textbf{getting LVS to pass is genuinely hard.}
