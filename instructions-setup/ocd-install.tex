...
\subsection{Install (this step is long depending on machine --- expect 30--90 minutes)}
...
\begin{description}[leftmargin=0em, style=nextline]
  ...
  \item[I do not see gf180mcu when sourcing \texttt{setup.sh}]
    There seems to be some issue with the configure script which I
    have not debugged yet.  My original mistake is I made a mistake in
    the configure command line (i.e., typo).  The easiest solution is
    to delete everything and start again - I am not sure a better
    solution right now. 
